...
Paper #FAF6F0 — 主背景，像一张放在窗边的信纸
Linen #F3ECE2 — 卡片表面，像一块未经漂白的麻布
Walnut #3D342E — 深色文字，像深秋的木质书桌
Ink #1A1614 — 最深的黑，像毛笔饱蘸之后落纸的第一笔
...
先观察，再开口。 它注意到了，但它等你准备好。
提问，而不是假设。 "要我把通知静音到中午吗？"——不是"我帮你静音了。"
保持阅读音量。 永远不是广播，永远是低声耳语。
...
快速开始
bashgit clone https://github.com/your-org/aether-app.git
cd aether-app
npm install
npm run dev
...
具体规范请参阅 CONTRIBUTING.md 与 DESIGN_SYSTEM.md。
